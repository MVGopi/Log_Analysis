...
Download the project zip file to you computer and unzip the file then place inside `vagrant/fsnd-log-analysis`.
  ...
  5.Unzip this file after downloading it. The file inside is called views.sql

  6. Copy the newsdata.sql file and place inside `vagrant/fsnd-log-analysis`.

  7. In terminal Change directory to `vagrant/fsnd-log-analysis` and look around with ls.
